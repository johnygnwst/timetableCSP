...
def same_spec(assignment):
    ...
    for i in arr:
        for j in arr:
            if equal(i._speciality._name, j._speciality._name) and \
                    i != j and \
...
def groups_conflict(assignment):
    ...
    for i in arr:
        for j in arr:
            if equal(i._type_of_class, j._type_of_class) and i != j and assignment[i] == assignment[j] and\
                    equal(i._speciality._name, j._speciality._name):
